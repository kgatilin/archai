...
const useFileSrc = (file: File | undefined) => {
  ...
  useEffect(() => {
    if (!file) {
      // eslint-disable-next-line react-hooks/set-state-in-effect -- cleanup on unmount
      setSrc(undefined);
      return;
    }
...
const AttachmentPreview: FC<AttachmentPreviewProps> = ({ src }) => {
  ...
  return (
    // eslint-disable-next-line @next/next/no-img-element -- preview images from file objects
    <img
      src={src}
